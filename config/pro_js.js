...
PPTBox.prototype = {
  _createMainBox: function() {
    ...
    html += "<div id='" + this.uid + "_imagebox' class='imagebox' style='width:" + this.width + "px;height:" + (this.picHeight + 2) + "px;bottom:25px;width:120px;margin:0 auto;'></div>";
    html += "</div>";
    document.write(html);
  },
  _init: function() {
  ...
  flashHTML: function(url, width, height, idx) {
    ...
    if (isFlash) {
      ...
      html = "<img src='" + url + "' style='width:1203px;height:335px;" + style + "' onclick = \"" + eventstr + ".clickPic(" + idx + ")\"/>";
    }
    return html;
  },
